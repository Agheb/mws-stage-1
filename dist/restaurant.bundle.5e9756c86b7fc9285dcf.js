!(function(e) {
  ...
  \****************************/
    /*! no exports provided */
    /*! all exports used */ function(e, A, t) {
      "use strict";
      Object.defineProperty(A, "__esModule", { value: !0 });
      var a = t(/*! lozad */ 16),
        c = t.n(a),
        n = t(/*! normalize.css/normalize.css */ 17),
        r = (t.n(n), t(/*! css-star-rating/css/star-rating.css */ 18)),
        h = (t.n(r), t(/*! ./assets/css/styles.css */ 19)),
        d = (t.n(h), t(/*! ./assets/js/dbhelper */ 20));
      var i;
      const E = c()();
      E.observe();
      t(/*! load-google-maps-api */ 21)({
      ...
      let p = e => {
        ...
        o = (e = self.restaurant) => {
          ...
          const a = t(/*! ./assets/data/img */ 30)(`./${e.photograph}`);
          (A.src = a.src),
            (A.srcset = a.srcSet),
  ...
  \*******************************************/
    ...
    /*! exports used: default */ function(e, A, t) {
...
* Copyright (c) 2018 Apoorv Saxena; Licensed MIT */ var a;
              ...
              )),
            {
              observe: function() {
                for (
                  ...
                  c(e[t]) ||
                    (p ? p.observe(e[t]) : (i(e[t]), a(e[t]), E(e[t])));
              },
  ...
  \***************************************************/
    /*! dynamic exports provided */ function(e, A) {},
  18:
    /*!***********************************************************!*\
