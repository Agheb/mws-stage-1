...
* Copyright (c) 2018 Apoorv Saxena; Licensed MIT */ var a;
  ...
  function(e, A, t) {
    ...
    let f = () => {
        E.a.fetchNeighborhoods((e, A) => {
          e ? console.error(e) : ((self.neighborhoods = A), Q());
        });
      },
      Q = (e = self.neighborhoods) => {
      ...
      B = () => {
        E.a.fetchCuisines((e, A) => {
          e ? console.error(e) : ((self.cuisines = A), l());
        });
      },
      l = (e = self.cuisines) => {
    ...
    p()({
      ...
      .then(e => {
        (s = new e.Map(document.getElementById("map"), {
          zoom: 12,
    ...
    const u = document.getElementById("neighborhoods-select"),
      w = document.getElementById("cuisines-select");
    ...
    let H = () => {
        const e = document.getElementById("cuisines-select"),
          ...
          c = e[t].value,
          n = A[a].value;
        E.a.fetchRestaurantByCuisineAndNeighborhood(c, n, (e, A) => {
          e ? console.error(e) : (b(A), S());
        });
      },
      b = e => {
        (self.restaurants = []),
      ...
      I = e => {
        ...
        (r.innerHTML = e.address), A.append(r);
        const d = document.createElement("a");
        return (
          (d.innerHTML = "View Details"),
          (d.href = E.a.urlForRestaurant(e)),
          A.append(d),
          A
        );
      },
      C = (e = self.restaurants) => {
        e.forEach(e => {
          const A = E.a.mapMarkerForRestaurant(e, s);
  ...
  function(e, A, t) {
    e.exports = t.p + "restaurants.json";
  },
  function(e, A, t) {
    e.exports = t.p + "manifest.json";
  }
]);
